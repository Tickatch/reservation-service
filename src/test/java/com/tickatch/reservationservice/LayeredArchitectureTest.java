...
@AnalyzeClasses(
    packages = "com.tickatch.reservationservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.tickatch.reservationservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.tickatch.reservationservice..presentation..")
        .layer("Application")
        .definedBy("com.tickatch.reservationservice..application..")
        .layer("Domain")
        .definedBy("com.tickatch.reservationservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.tickatch.reservationservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.tickatch.reservationservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.tickatch.reservationservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.tickatch.reservationservice.global..")
        .should()
        .dependOnClassesThat()
