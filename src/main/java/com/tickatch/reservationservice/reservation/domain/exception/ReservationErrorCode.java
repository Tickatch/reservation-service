...
public enum ReservationErrorCode implements ErrorCode {
  ...
  STATUS_IS_NOT_PAYMENT_PENDING(HttpStatus.BAD_REQUEST.value(), "STATUS_IS_NOT_PAYMENT_PENDING"),
  ...
  INVALID_STATUS_FOR_EXPIRE(HttpStatus.BAD_REQUEST.value(), "INVALID_STATUS_FOR_EXPIRE"),
  EXPIRE_TIME_NOT_REACHED(HttpStatus.BAD_REQUEST.value(), "EXPIRE_TIME_NOT_REACHED"),
  INVALID_STATUS_FOR_PAYMENT_START(
      HttpStatus.BAD_REQUEST.value(), "INVALID_STATUS_FOR_PAYMENT_START"),
  INVALID_STATUS_FOR_REFUND_CANCEL(
      HttpStatus.BAD_REQUEST.value(), "INVALID_STATUS_FOR_REFUND_CANCEL"),
  RESERVATION_OWNER_MISMATCH(HttpStatus.BAD_REQUEST.value(), "RESERVATION_OWNER_MISMATCH"),
