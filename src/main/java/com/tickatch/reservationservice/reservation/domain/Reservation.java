...
public class Reservation extends AbstractAuditEntity {
  ...
  //1. 예매 생성
  @Builder
  public Reservation(UUID reservationId, UUID reserverId, String reserverName, long productId,
      String productName, long seatId, String seatNumber, Long price,
    ...
    // 좌석이 예매 가능한지 체크, 가능하지 않으면 예외 발생
    if (!seatAvailableCheck.check(seatId)) {
      throw new ReservationException(ReservationErrorCode.INVALID_RESERVE_SEAT);
    }
